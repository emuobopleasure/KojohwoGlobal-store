                ...
                <div className="card bg-base-100 shadow-lg hover:shadow-2xl h-[17rem] rounded-3xl flex flex-col justify-around items-center overflow-hidden sm:flex-row w-[12rem] sm:h-52 sm:w-auto md:w-[43vw] lg:w-[23rem] transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 duration-300">
                    ...
                    <div className="flex-1 w-full flex flex-col items-baseline justify-around h-1/2 px-4 sm:h-full sm:items-baseline sm:w-1/2">
                        ...
                        <div className="w-auto mx-auto md:mx-0">
                            ...
                            /> */}
                            <button className="add-to-wish w-full px-[6px] py-[4px] gap-[2px] flex items-center bg-btnColor text-white font-medium text-[0.7rem] md:text-sm leading-snug capitalize rounded-full shadow-md hover:bg-pink-500 hover:shadow-lg focus:bg-pink-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-pink-800 active:shadow-lg transition duration-150 ease-in-out">
                                <AiOutlineHeart />
                                Add to Wishlist
                            </button>
                        </div>
