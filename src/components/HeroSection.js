            ...
            <div className="hero-section bg-base-100 mb-[4rem] landscape:h-screen sm:h-screen sm:mb-0">
                <div className="hero-container flex flex-col landscape:flex-row-reverse landscape:items-center gap-6 md:gap-12 lg:gap-3 lg:flex-row-reverse items-center">
                    <div className='image-wrapper basis-[40%] lg:basis-[50%] w-full'>
                        <img src="/images/heroImage2.jpg" alt='hero image' className="her0-image w-full h-[45vh] md:h-[53vh] lg:h-[90vh] landscape:h-screen object-cover rounded-lg shadow-lg md:shadow-2xl" />
                    </div>
