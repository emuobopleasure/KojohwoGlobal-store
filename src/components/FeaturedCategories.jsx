                        ...
                        <article className='category-card rounded-3xl bg-base-100 shadow-lg group cursor-pointer border-gray-200 border-2 w-full hover:shadow-2xl transition-all duration-300 ease-in-out'>
                            ...
                            <div className='card-bottom mt-4 mb-[4px] flex items-center justify-between px-[4px] border border-accent rounded-full w-[93%] mx-auto group-hover:bg-accent transition-colors duration-300 ease-in-out py-[2px]'>
                                ...
                                <div className='flex-shrink-0'>
                                    <GoArrowRight
                                        size={'1.2rem'}
                                        className='border border-base-100 rounded-full p-[1px] text-base-100 bg-accent group-hover:scale-105 lg:group-hover:scale-110 transition-all ease-out duration-300 group-hover:rounded-full'
                                    />
                                </div>
                            </div>
                        </article>
