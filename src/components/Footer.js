...
const Footer = () => {
    return (
        <footer data-theme="" className="footer footer-center p-10 bg-base-300 text-gray-700 mt-20 rounded-t-3xl">
            <div className="grid grid-flow-col gap-4">
                ...
                <a href='#top' className='bact-to-top'>
                    <button className='flex items-center gap-[0.3rem]'>
                        ...
                        <div className='arrow-up p-[5px] rounded-[40%] border-[1px] border-[#374151]'>
                            <AiOutlineArrowUp />
                        </div>
                    </button>
                </a>
            ...
            <div>
                <div className="grid grid-flow-col gap-4">
                    <Link to='' className='whatsapp p-[10px] rounded-[40%] border-[1px] border-[#374151] hover:text-[white] hover:bg-[#374151]'>
                        <RiWhatsappFill size='1.2rem' />
                    </Link>
                    <Link to='' className='facebook p-[10px] rounded-[40%] border-[1px] border-[#374151] hover:text-[white] hover:bg-[#374151]'>
                        <FaFacebookF size='1.2rem' />
                    </Link>
                    <Link to='' className='instagram p-[10px] rounded-[40%] border-[1px] border-[#374151] hover:text-[white] hover:bg-[#374151]'>
